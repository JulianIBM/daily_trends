const scraperObject = {
    ...
    if(url == "https://elpais.com/") {
      ...
      var altImage = 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Elpais-co.svg/1280px-Elpais-co.svg.png';
    }
    else {
      var selector = '.main';
      ...
      var altImage = 'https://e00-elmundo.uecdn.es/assets/v19/img/destacadas/elmundo__logo-generica.jpg';
    }
    ...
    // Loop through each of those links, open a new page instance and get the relevant data from them
		let pagePromise = (link) => new Promise(async(resolve, reject) => {
			...
			dataObj['title'] = await newPage.$eval(title, text => text.textContent);
			dataObj['body'] = await newPage.$(body) ? await newPage.$eval(body, text => text.textContent) : ' ';
      ...
      dataObj['publisher'] = publisher;
			dataObj['imagePath'] = await newPage.$(imageUrl) ? await newPage.$eval(imageUrl, img => img.src) : altImage;
			resolve(dataObj);
			await newPage.close();
		});
